...
export async function GET(request, { params }) {
    ...
    try {
        ...
        // FIX: The report content is ALREADY HTML (generated by AI with strict instructions).
        // Parsing it with 'marked' treats the HTML tags as code blocks if indented, breaking the layout.
