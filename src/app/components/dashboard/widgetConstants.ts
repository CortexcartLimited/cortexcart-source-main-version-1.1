import {
    ...
    Package, Type, ShoppingBag, Receipt, Store, Share2, ThumbsUp, MessageCircle
} from 'lucide-react';
...
export const WIDGET_CATALOG = [
    {
        ...
        items: [
            ...
            { type: 'QuickBooksStatCard', label: 'QB Total Revenue', icon: Receipt, defaultSize: '1/3', defaultProps: { title: 'QB Revenue', description: 'Fiscal Year', dataKey: 'totalRevenue' } },
            { type: 'QuickBooksStatCard', label: 'QB Total Expenses', icon: Receipt, defaultSize: '1/3', defaultProps: { title: 'QB Expenses', description: 'Fiscal Year', dataKey: 'totalExpenses' } },
            { type: 'QuickBooksStatCard', label: 'QB Net Profit', icon: TrendingUp, defaultSize: '1/3', defaultProps: { title: 'QB Net Profit', description: 'Fiscal Year', dataKey: 'netProfit' } },
            { type: 'ShopifyStatCard', label: 'Shopify Sales', icon: ShoppingBag, defaultSize: '1/3', defaultProps: { title: 'Store Sales', description: 'All-time Net', dataKey: 'totalSales', className: 'bg-blue-50 dark:bg-blue-900/20' } },
            { type: 'ShopifyStatCard', label: 'Shopify Visits', icon: Users, defaultSize: '1/3', defaultProps: { title: 'Total Visits', description: 'All-time Sessions', dataKey: 'totalVisits', className: 'bg-green-50 dark:bg-green-900/20' } },
    ...
    },
    {
        ...
        items: [
            ...
            { type: 'QuickBooksChart', label: 'Financial Overview', icon: BarChart, defaultSize: 'Full', defaultProps: { title: 'Financial Overview' } },
            { type: 'ShopifyProductList', label: 'Product List', icon: Package, defaultSize: 'Full', defaultProps: { title: 'Your Products' } },
        ]
    },
    {
