...
import AnalyticsTabContent from '@/app/components/social/AnalyticsTabContent';
import FriendlyError from '@/app/components/FriendlyError';


import { PLATFORMS, PinterestIcon, TikTokIcon, YouTubeIcon } from './social-config';

const SocialNav = ({ activeTab, setActiveTab }) => {
    const tabs = [{ name: 'Analytics', icon: ArrowUpTrayIcon }, { name: 'Composer', icon: PencilSquareIcon }, { name: 'Schedule', icon: CalendarIcon }, { name: 'Demographics', icon: InformationCircleIcon }, { name: 'Mailchimp', icon: ClipboardDocumentIcon }];
    return (
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        />
                        <div className="mt-4">
                            <label htmlFor="countryInput" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Target Country</label>
                            <input
                                type="text"
                                id="countryInput"
                                name="country"
